...
GOOGLE_CLIENT_ID = "716011780697-kfsplcomlfq2ekklvjd0t7m2id3qgbvg.apps.googleusercontent.com"
...
app.config['MONGO_URI']= 'mongodb+srv://tatenda:tatenda@cluster0.c3jxxpq.mongodb.net/JobRecruitment'
